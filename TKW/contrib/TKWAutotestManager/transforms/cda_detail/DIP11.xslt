<xsl:stylesheet xmlns:hl7="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:param name="message">
		<message name="DIP11">
			<headers>
				<header name="recordTargetUniversal_DIP11_POCD_MT150001UK06"/>
			...
			<entries>
				<entry name="COCD_TP146330GB01MedicationAdministrationCourse_a71"/>
			</entries>
			<components>
				<component name="a71_01FF5CFE-5008-D07D-E050-950AE0731D36"/>
			</components>
		</message>
	</xsl:param>
	<xsl:template match="/">
