<xsl:stylesheet xmlns:hl7="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:param name="message">
		<message name="THN1">
			<headers>
				<header name="recordTargetUniversal_THN1_POCD_MT130001UK05"/>
			...
			<entries>
				<entry name="COCD_TP146049UK05Reason_a1354"/>
			</entries>
			<components>
				<component name="a1354_FEE0ECF4-AE8D-A902-E040-950AE0737DEC"/>
			</components>
		</message>
	</xsl:param>
	<xsl:template match="/">
