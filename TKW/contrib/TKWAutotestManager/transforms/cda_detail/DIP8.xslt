<xsl:stylesheet xmlns:hl7="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:param name="message">
		<message name="DIP8">
			<headers>
				<header name="recordTargetUniversal_DIP8_POCD_MT150001UK06"/>
			...
			<entries>
				<entry name="COCD_TP146322GB01AllergyEvent_a68"/>
			</entries>
			<components>
				<component name="a68_01FF5CFE-5001-D07D-E050-950AE0731D36"/>
			</components>
		</message>
	</xsl:param>
	<xsl:template match="/">
