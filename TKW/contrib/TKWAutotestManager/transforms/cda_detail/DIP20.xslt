<xsl:stylesheet xmlns:hl7="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:param name="message">
		<message name="DIP20">
			<headers>
				<header name="recordTargetUniversal_DIP20_POCD_MT150001UK06"/>
			...
			<entries>
				<entry name="COCD_TP146322GB01AllergyEvent_a96"/>
			</entries>
			<components>
				<component name="01FF5CFE-502B-D07D-E050-950AE0731D36"/>
				<component name="a96_01FF5CFE-5032-D07D-E050-950AE0731D36"/>
			</components>
		</message>
	</xsl:param>
	<xsl:template match="/">
