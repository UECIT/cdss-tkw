<xsl:stylesheet xmlns:hl7="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:param name="message">
		<message name="DIP17">
			<headers>
				<header name="recordTargetUniversal_DIP17_POCD_MT150001UK06"/>
			...
			<entries>
				<entry name="COCD_TP146333GB01SupplyMedication_a78"/>
			</entries>
			<components>
				<component name="a78_01FF5CFE-5017-D07D-E050-950AE0731D36"/>
			</components>
		</message>
	</xsl:param>
	<xsl:template match="/">
