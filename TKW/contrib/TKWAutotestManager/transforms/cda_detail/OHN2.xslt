<xsl:stylesheet xmlns:hl7="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:param name="message">
		<message name="OHN2">
			<headers>
				<header name="recordTargetUniversal_OHN2_POCD_MT130001UK05"/>
			...
			<entries>
				<entry name="COCD_TP146049UK05Reason_a1155"/>
			</entries>
			<components>
				<component name="a1155_01FF5CFE-5224-D07D-E050-950AE0731D36"/>
			</components>
		</message>
	</xsl:param>
	<xsl:template match="/">
