<?xml version="1.0"?>
<!-- $Id: SO_INVUSR.xslt 557 2016-03-07 13:58:11Z sfarrow $ -->
<!-- SO_INVUSR Inavlid Username -->
...
<xsl:template match="wsse:Username">
	<xsl:comment>Username element set to Unknown by TKW AutotestManager</xsl:comment>
	<xsl:copy>
