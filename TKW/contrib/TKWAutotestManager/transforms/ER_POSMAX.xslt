...
<!-- $Id: ER_POSMAX.xslt 557 2016-03-07 13:58:11Z sfarrow $ -->
<!-- ER_POSMAX message not too large  CDA add an attachment non CDA add an extra payload -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="file" select="'contrib/TKWAutotestManager/tstp/smallfile.b64'"/>
